export default function SelectArticleSidebar() {
    return (
      <div className="flex gap-5 h-full w-[50rem]">
        <div className="p-2 md:pt-6 md:pl-8 md:pr-8 rounded-tl-3xl rounded-l-3xl border border-neutral-200 opacity-50 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col flex-1">
